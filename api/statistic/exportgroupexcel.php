<?php
    ...
    $type=$_POST["type"];
    $file_title=$currY."祈願法會 義工名冊(分組)";
    $table_title=$currY."祈願法會 義工名冊";
   //------------------------------------------------------------------------------------------------------------------------------
    ...
    $sheetNameAry=array("大會","教育大組","庶務大組","總務大組","福田大組","廣供大組","餐飲大組","交通大組","多媒體影音","法務組","海外組","護戒組","師長飲食","觀音亭專區","光明燈專案");
    ...
    for($nSheet=0;$nSheet<count($groupFilterAry);$nSheet++){
        if ($nSheet>0){
