...
<body>
    <div id="wrapper">
        ...
        <?php
            echo "<input type='hidden' id='checkin-day' class='checkin-day' name='checkin-day' value=".$day." />";
        ?>
        <!-- Page Content -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">義工正行報到登錄</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
    ...
    <script src="../resource/js/checkin.js?{CEB87E65-C982-482A-8016-17D959F55212}" type="text/javascript" charset="utf-8"></script>
</body>
