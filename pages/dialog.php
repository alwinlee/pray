<?php
    ...
    echo "<h4 class=\"modal-title\" id=\"myModalLabel\">".$sysname."義工報名</h4>";
    echo "</div>";
    ...
    echo "<h4 class=\"modal-title\" id=\"myModalLabel\">重覆報名</h4>";
    echo "</div>";
    ...
    echo "<div class=\"modal-header\">";
    echo "<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>";
    echo "<h4 class=\"modal-title\" id=\"myModalLabel\">義工報名</h4>";
    echo "</div>";
    ...
    echo "<div class=\"modal fade\" id=\"confirm-param\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">";
    echo "<div class=\"modal-dialog\">";
    echo "<div class=\"modal-content\">";
    echo "<div class=\"modal-header\">";
    echo "<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">×</button>";
    echo "<h4 class=\"modal-title\" id=\"myModalLabel\">參數設定</h4>";
    echo "</div>";
    echo "<div class=\"modal-body\" id=\"confirm-param-information\">";
    echo "</div>";
    echo "<div class=\"modal-footer\">";
    echo "<button type=\"button\" class=\"btn btn-danger\" id=\"confirm-param-information-ok\" data-dismiss=\"modal\">確定</button>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
    echo "</div>";