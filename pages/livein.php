...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">住宿調整異動</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">住宿變更</h4>
                          </div>
                    ...
                    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="statusCancel">
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabel">住宿取消</h4>
                          </div>
                          <div class="modal-body text-center">
                            成功!
                          </div>
    ...
    <script src="../resource/js/livein.js?{51DDD4FB-D26B-4C7F-A56A-2129EEE72173}" type="text/javascript" charset="utf-8"></script>
</body>
