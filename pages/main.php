...
<body>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <p>1. 報名日期：2022年12月3日(六)~ 12月25日(日)</p>
                            <p>2. 需要提早進駐組別，請在備註寫，進駐日期</p>
                            <p>3. 報名系統聯絡人：蕭郁蓉師姐 0928-751-712，(07)3805895#323</p>
                            <p>4. 義工報名相關問題請聯絡各大組助理。</p>
                        </div>
                        <!--
                        &nbsp;
    ...
    <script src="../resource/js/api.js?{F43BAD84-E62B-494D-9A51-863AF3C77EFC}" type="text/javascript" charset="utf-8"></script>
    <script src="../resource/js/main.js?{F43BAD84-E62B-494D-9A51-863AF3C77EFC}" type="text/javascript" charset="utf-8"></script>
</body>
