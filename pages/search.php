...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			...
			<ul class="nav navbar-top-links navbar-left">
                <li><a class="navbar-brand" href="index.html" > 祈願法會義工報名報到</a></li>
            </ul>
            <!-- -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <h3 class="page-header">祈願法會義工報名報到 學生資料查詢</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
    ...
    <script src="../resource/js/search.js?{F43BAD84-E62B-494D-9A51-863AF3C77EFC}" type="text/javascript" charset="utf-8"></script>
</body>
